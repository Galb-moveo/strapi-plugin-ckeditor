...
import { TemplateInstructionsPlugin } from './plugins/TemplateInstructionsPlugin';
...
export default class Configurator {
	...
	getEditorConfig() {
		...
		// Debug to see what's available in fieldConfig
		console.log('Field config:', this.fieldConfig);

		// Try different ways to access the description
		if (this.fieldConfig.description) {
			config.templateInstructions = this.fieldConfig.description;
		} else if (this.fieldConfig.hint) {
			config.templateInstructions = this.fieldConfig.hint;
		} else if (
			this.fieldConfig.options &&
			this.fieldConfig.options.description
		) {
			config.templateInstructions = this.fieldConfig.options.description;
		}
